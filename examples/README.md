# Behemoth Hello World Demo

This directory contains a foundational "Hello World" application that demonstrates the four core capabilities of the Behemoth plugin architecture.
